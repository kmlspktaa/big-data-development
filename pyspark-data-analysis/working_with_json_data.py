...
shows = spark.read.json("/Users/kamalsapkota/Desktop/dataLake/2023/spark/big-data-development/pyspark-data-analysis-data/shows-silicon-valley.json")
...
three_shows = spark.read.json(
    "/Users/kamalsapkota/Desktop/dataLake/2023/spark/big-data-development/pyspark-data-analysis-data/shows-*.json", multiLine=True
)
